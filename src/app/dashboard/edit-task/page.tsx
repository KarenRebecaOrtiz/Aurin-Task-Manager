    ...
    <div className={styles.container}>
      <div className={styles.header} ref={(el) => { sectionsRef.current[0] = el; }}>
        ...
        <div className={styles.headerContent}>
          <div className={styles.title}>Editar Tarea</div>
          <div className={styles.subtitle}>
            Modifica los detalles de la tarea. Los cambios se guardarán y serán visibles para todas las personas involucradas.
          </div>
        </div>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              ...
              <div className={styles.dropdownContainer} ref={statusDropdownRef}>
                ...
                {isStatusDropdownOpen && (
                  <div className={styles.dropdownItems}>
                    {['Por Iniciar', 'En Proceso', 'Diseño', 'Desarrollo', 'Backlog', 'Finalizado', 'Cancelado'].map((status) => (
                      <div
                        key={status}
                        className={styles.dropdownItem}
