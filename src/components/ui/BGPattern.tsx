...
const BGPattern = ({
  ...
  // Use CSS variable if fill is not provided
  const fillColor = fill || 'var(--pattern-fill, rgba(192, 192, 192, 0.05))';
  const backgroundImage = getBgImage(variant, fillColor, size);
