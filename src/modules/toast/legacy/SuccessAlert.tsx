/**
 * SuccessAlert - LEGACY (Deprecated)
 * Este componente ha sido reemplazado por el nuevo sistema de toasts centralizado
 * 
 * Migración: Usa useToast().success() en su lugar
 * 
 * @deprecated Usar useToast().success() del módulo @/modules/toast
 */
...
const SuccessAlert: React.FC<SuccessAlertProps> = ({ message, onClose, onAction, actionLabel }) => {
    ...
    const id = sonnerToast.custom(
      () => (
        <div className={styles.notificationsContainer}>
          <div className={styles.card} ref={toastRef}>
            ...
            <div className={styles.messageTextContainer}>
              <p className={styles.messageText}>Éxito</p>
  ...
  }, [message, onClose, onAction, actionLabel, audioError]);
