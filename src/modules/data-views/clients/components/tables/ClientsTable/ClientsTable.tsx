...
import { useClientsTableState } from './hooks/useClientsTableState';
...
const ClientsTable: React.FC<ClientsTableProps> = memo(
  ({ onCreateOpen, onEditOpen, onDeleteOpen, externalClients, onCacheUpdate }) => {
    ...
    // ✅ Hook consolidado para estado de ClientsTable
    const {
      clients,
      filteredClients,
      sortKey,
          ...
          if (col.key === 'imageUrl') {
            return {
              ...
              render: (client: Client) => (
                <ClientCell
                  client={{ id: client.id, name: client.name, imageUrl: client.imageUrl }}
                />
              ),
            };
          }
